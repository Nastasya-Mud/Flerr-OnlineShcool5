...
const seedData = async () => {
  try {
    ...
    await Gallery.create({
      title: 'Роскошный свадебный букет',
      imageUrl: 'https://images.unsplash.com/photo-1535398089889-dd807df1dfaa?w=800',
      category: 'свадьбы',
      description: 'Элегантный свадебный букет с пионовидными розами в нежных тонах',
      order: 1,
      featured: true,
    });

    await Gallery.create({
      title: 'Стильная композиция с протеей',
      imageUrl: 'https://images.unsplash.com/photo-1572195578551-5465dd163390?w=800',
      category: 'букеты',
      description: 'Современная композиция с экзотической протеей и розами',
      order: 2,
      featured: true,
    });

    await Gallery.create({
      title: 'Букет невесты бохо-шик',
      imageUrl: 'https://images.unsplash.com/photo-1505865858147-09f15cd1deb6?w=800',
      category: 'свадьбы',
      description: 'Богемный свадебный букет с розами и эвкалиптом',
      order: 3,
      featured: true,
    });

    await Gallery.create({
      title: 'Пудровая элегантность',
      imageUrl: 'https://images.unsplash.com/photo-1516297126394-be37e2bc8b75?w=800',
      category: 'букеты',
      description: 'Нежная композиция в пудровых тонах с розами и пионами',
      order: 4,
      featured: true,
    });
    ...
    await Gallery.create({
      ...
      imageUrl: 'https://images.unsplash.com/photo-1496062031456-07b8f162a322?w=800',
      category: 'композиции',
      description: 'Роскошная композиция из роз в стильной коробке',
      order: 5,
      featured: true,
    });

    await Gallery.create({
      title: 'Монохромная изысканность',
      imageUrl: 'https://images.unsplash.com/photo-1525310072745-f49212b5ac6d?w=800',
      category: 'букеты',
      description: 'Элегантный букет в белых тонах для особого случая',
      order: 6,
      featured: true,
    });

    await Gallery.create({
      title: 'Букет с ранункулюсами',
      imageUrl: 'https://images.unsplash.com/photo-1455659817273-f96807779a8a?w=800',
      category: 'букеты',
      description: 'Очаровательная композиция с ранункулюсами и розами',
      order: 7,
      featured: true,
    });

    await Gallery.create({
      title: 'Дизайнерская композиция',
      imageUrl: 'https://images.unsplash.com/photo-1487070183336-b863922373d4?w=800',
      category: 'композиции',
      description: 'Авторская флористическая композиция в современном стиле',
      order: 8,
      featured: true,
    });
